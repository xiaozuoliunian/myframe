...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="/plugin/veuve/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
    <link href="/plugin/veuve/css/font-awesome.min93e3.css?v=4.4.0" rel="stylesheet">

    <!-- Morris -->
    <link href="/plugin/veuve/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="/plugin/veuve/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">

    <link href="/plugin/veuve/css/animate.min.css" rel="stylesheet">
    <link href="/plugin/veuve/css/style.min862f.css?v=4.1.0" rel="stylesheet">
...
<script src="/plugin/veuve/js/jquery.min.js?v=2.1.4"></script>
<script src="/plugin/veuve/js/bootstrap.min.js?v=3.3.6"></script>
<script src="/plugin/veuve/js/plugins/flot/jquery.flot.js"></script>
<script src="/plugin/veuve/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="/plugin/veuve/js/plugins/flot/jquery.flot.spline.js"></script>
<script src="/plugin/veuve/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="/plugin/veuve/js/plugins/flot/jquery.flot.pie.js"></script>
<script src="/plugin/veuve/js/plugins/peity/jquery.peity.min.js"></script>
<script src="/plugin/veuve/js/demo/peity-demo.min.js"></script>
<script src="/plugin/veuve/js/content.min.js?v=1.0.0"></script>
<script src="/plugin/veuve/js/plugins/jquery-ui/jquery-ui.min.js"></script>
<script src="/plugin/veuve/js/plugins/gritter/jquery.gritter.min.js"></script>
<script src="/plugin/veuve/js/plugins/easypiechart/jquery.easypiechart.js"></script>
<script src="/plugin/veuve/js/plugins/sparkline/jquery.sparkline.min.js"></script>
<script src="/plugin/veuve/js/demo/sparkline-demo.min.js"></script>
<script>
