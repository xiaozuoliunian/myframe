                        ...
                        <div class="row col-xs-11">
                            <div class="form-group">
                                <label class="col-xs-3 control-label text-right pt5">
                                    <span class="fa fa-asterisk text-danger mr5"></span>菜单标题
                                </label>
                                <div class="col-xs-8">
                                    <input class="form-control" id="menuTitle" name="menuTitle" StringMaxLength="50" required>
                                </div>
                            </div>
                        </div>
                        <div class="row col-xs-11">
                            <div class="form-group">
                                <label class="col-xs-3 control-label text-right pt5">
                                    <span class="fa fa-asterisk text-danger mr5"></span>菜单链接
                                </label>
                                <div class="col-xs-8">
                                    <input class="form-control" id="menuUrl" name="menuUrl" StringMaxLength="50" required>
                                </div>
                            </div>
                        </div>
                        <div class="row col-xs-11">
                            <div class="form-group">
                                <label class="col-xs-3 control-label text-right pt5">
                                    <span class="fa fa-asterisk text-danger mr5"></span>菜单图标
                                </label>
                                <div class="col-xs-8">
                                    <input class="form-control" id="menuIcon" name="menuIcon" StringMaxLength="50" required>
                                </div>
                            </div>
                        </div>
            ...
            if(_id){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if(data){
                            $("#inputForm").setTagsValue(data.menuInfo);
                        }else{
